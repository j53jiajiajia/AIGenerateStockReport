...
and put KaiTi.ttf, KaiTi-Bold.ttf, and SimHei.ttf in the Lib\site-packages\reportlab\fonts file directory and (KaiTi.ttf in /usr/share/fonts/KaiTi if you use ubuntu) before you run the code.
### OpenAI Key:
